...
pub type DevInstant = fugit::TimerInstantU64<1_000_000>;
pub type DevDuration = fugit::TimerDurationU64<1_000_000>;
...
impl rtic_monotonic::Monotonic for MonoTimer {
    ...
    type Instant = DevInstant;
    type Duration = DevDuration;
