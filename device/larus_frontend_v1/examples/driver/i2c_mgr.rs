...
/// so it only allows sharing within a single thread (interrupt priority level).
///
...
use embedded_hal::blocking::i2c::{self, Read, SevenBitAddress, TenBitAddress, Write, WriteRead};
use stm32h7xx_hal::{
    device::I2C1,
