...
use super::audio::{AudioParams, SquareWave, desired_spec};
...
pub struct SdlWindow {
    ...
    audio_queue: &'static Lazy<ConcurrentQueue<AudioParams>>,
...
impl SdlWindow {
        ...
        C: PixelColor + Into<Rgb888>,
    {
        ...
        static AUDIO_QUEUE: Lazy<ConcurrentQueue<AudioParams>> = Lazy::new(|| ConcurrentQueue::bounded(20));
