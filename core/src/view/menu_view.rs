...
use embedded_graphics::{
    draw_target::DrawTarget, geometry::Point, prelude::Size, primitives::{Line, Primitive, PrimitiveStyle, Rectangle}, Drawable
};
...
impl MenuView {
        ...
        D: DrawTarget<Color = Colors, Error = CoreError> + DrawImage,
    {
        ...
        Line::new(
                Point::new(0, y), 
                Point::new(DISPLAY_WIDTH as i32, y))
                .into_styled(
                    PrimitiveStyle::with_stroke(cm.color(Palette::Scale), 1))
                .draw(display)?;
