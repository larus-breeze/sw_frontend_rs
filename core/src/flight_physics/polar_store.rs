...
pub const POLAR_COUNT: usize = 169;
...
pub const POLARS: [BasicGliderData; POLAR_COUNT] = [
    ...
    BasicGliderData {
        ...
        handicap: 122,
        polar_values: [[81.6, -0.511], [97.2, -0.556], [180.0, -1.369]],
    },
    BasicGliderData {
