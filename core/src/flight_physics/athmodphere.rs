...
pub fn pressure(altitude: Length) -> Pressure {
    const COEFS: [Float; 4] = [-1.08815563e-08, 5.57230085e-04, -1.19665733e+01, 1.01302034e+05];
    Pressure(horner(altitude.0, &COEFS))
}

// Error below 0.02% between 0..10_000m
pub fn density(altitude: Length) -> Density {
    const COEFS: [Float; 4] = [-6.38071857e-14, 4.26830074e-09, -1.17451181e-04, 1.22492440e+00];
...
pub fn altitude(static_air_pressure: Pressure) -> Length {
    const COEFS: [Float; 6] = [-1.56145960e-21, 6.09947157e-16, -9.88928010e-11, 8.84184638e-06, -5.46163448e-01, 1.98197754e+04];
...
impl PressureAltitude {
    ...
    pub fn qne_altitude(&self, static_air_pressure: Pressure) -> Length {
        altitude(static_air_pressure)
    }
