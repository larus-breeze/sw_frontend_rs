...
pub struct Images {
    ...
    pub battery: &'static [u8],
    pub club_0: &'static [u8],
    ...
    pub m_s: &'static [u8],
    pub pitch: &'static [u8],
    pub roll_left: &'static [u8],
    pub roll_right: &'static [u8],
    pub slip: &'static [u8],
    pub v: &'static [u8],
    pub ve: &'static [u8],
    pub yaw: &'static [u8],
    pub normal_0: &'static [u8],
    pub normal_1: &'static [u8],
    pub normal_2: &'static [u8],
    pub normal_3: &'static [u8],
    pub north: &'static [u8],
    pub sat: &'static [u8],
