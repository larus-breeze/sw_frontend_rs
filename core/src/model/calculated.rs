use crate::{
    controller::{SoundParams, SunsetResult},
...
pub struct Calculated {
    ...
    pub sunset_time: SunsetResult,
    pub sunset_valid: bool,
    pub sunset_local_time: SunsetResult,
    pub sunset_local_valid: bool,
    pub sunset_reference_lat_deg: f32,
    pub sunset_reference_lon_deg: f32,
    pub sunset_reference_valid: bool,
    pub sunset_takeoff_valid: bool,
    pub sunset_takeoff_speed_ticks: u8,
    pub frequency: u16,
    pub continuous: bool,
    pub gain: i8,
...
impl Default for Calculated {
    ...
    fn default() -> Self {
        Calculated {
            ...
            sunset_time: SunsetResult::default(),
            sunset_valid: false,
            sunset_local_time: SunsetResult::default(),
            sunset_local_valid: false,
            sunset_reference_lat_deg: 0.0,
            sunset_reference_lon_deg: 0.0,
            sunset_reference_valid: false,
            sunset_takeoff_valid: false,
            sunset_takeoff_speed_ticks: 0,
            frequency: 500,
            continuous: false,
            gain: 2,
