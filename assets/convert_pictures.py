...
lif_gen.generate(1, 'glider.png', {0: DARK_GRAY})
lif_gen.generate(1, 'north.png', {0: DARK_GRAY})
lif_gen.generate(1, 'spiral.png', {0: DARK_GRAY})
lif_gen.generate(1, 'straight.png', {0: DARK_GRAY})
lif_gen.generate(1, 'km_h.png', {0: DARK_GRAY})
lif_gen.generate(1, 'm_s.png', {0: DARK_GRAY})
lif_gen.generate(1, 'sat.png', {0: DARK_GRAY})
lif_gen.generate(1, 'wp_vario.png', {0: DARK_GRAY})
lif_gen.generate(1, 'wp_horizon.png', {0: DARK_GRAY})
...
lif_gen.generate(1, 'm_s.png', {0: DARK_GRAY})
lif_gen.generate(1, 'sat.png', {0: DARK_GRAY})
lif_gen.generate(2, 'wp_vario.png', {0: WHITE})
lif_gen.generate(2, 'wp_horizon.png', {0: WHITE})

lif_gen = LifGen(480, 480, 'assets/size_480x480', 'core/assets/size_480x480')
lif_gen.generate(1, 'bat_empty.png', {0: RED})
lif_gen.generate(1, 'bat_full.png', {0: DARK_GRAY, 1: LIME})
lif_gen.generate(1, 'bat_half.png', {0: DARK_GRAY, 1: GOLD})
lif_gen.generate(1, 'glider.png', {0: DARK_GRAY})
