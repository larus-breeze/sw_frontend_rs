...
PICTURES = (
    ...
    (4, 'battery.png', {0: DARK_GRAY, 255: BACKGROUND}),
    (4, 'club-0.png', {0: DARK_GRAY, 255: BACKGROUND}),
    ...
    (4, 'g-load.png', {0: DARK_GRAY, 255: BACKGROUND}),
    (4, 'g.png', {0: DARK_GRAY, 255: BACKGROUND}),
    (4, 'ias.png', {0: DARK_GRAY, 255: BACKGROUND}),
    (4, 'pitch.png', {0: DARK_GRAY, 255: BACKGROUND}),
    (4, 'roll_left.png', {0: DARK_GRAY, 255: BACKGROUND}),
    (4, 'roll_right.png', {0: DARK_GRAY, 255: BACKGROUND}),
    (4, 'slip.png', {0: DARK_GRAY, 255: BACKGROUND}),
    (4, 'Ve.png', {0: DARK_GRAY, 255: BACKGROUND}),
    (4, 'yaw.png', {0: DARK_GRAY, 255: BACKGROUND}),
    ...
    (4, 'V.png', {0: DARK_GRAY, 255: BACKGROUND}),
    (4, 'normal-0.png', {0: DARK_GRAY, 255: BACKGROUND}),
    (4, 'normal-1.png', {0: DARK_GRAY, 255: BACKGROUND}),
    (4, 'normal-2.png', {0: DARK_GRAY, 255: BACKGROUND}),
    (4, 'normal-3.png', {0: DARK_GRAY, 255: BACKGROUND}),
    ...
    (4, 'spiral.png', {0: DARK_GRAY, 255: BACKGROUND}),
    (4, 'straight.png', {0: DARK_GRAY, 255: BACKGROUND}),
